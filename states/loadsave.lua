...
function LoadSave:draw()
    ...
    for y = 0, screenH, 32 do
        for x = 0, screenW, 32 do
            ...
            setColor(0.06 + wave, 0.08 + wave, 0.12 + wave)
    ...
    if #self.saveFiles == 0 then
        ...
        for i, entry in ipairs(self.saveFiles) do
            if i <= maxVisible then
                ...
                setColor(bgColor[1], bgColor[2], bgColor[3], 0.9)
                ...
                setColor(borderColor[1], borderColor[2], borderColor[3], selectPulse)
                ...
                setColor(isSelected and 0.95 or 0.75, isSelected and 0.95 or 0.75, isSelected and 1 or 0.80)
                love.graphics.print(entry.data.characterName or "Unnamed", nameX, itemY + 8)

                -- Level badge
                local lvlText = "Lv." .. (entry.data.level or 1)
                setColor(0.30, 0.40, 0.50)
